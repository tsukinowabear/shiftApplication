        ...
        <body>
            ...
            <div class='body clear'>
                @foreach($shifts as $shift)
                    ...
                    <div class='right'>
                        <button type='button' onclick="location.href='/shifts/confirm/desired/{{ $shift->id }}'">詳細</button>
                        <button type='button' onclick="location.href='/shifts/confirm/desired/{{ $shift->id }}/create'">シフト作成</button>
