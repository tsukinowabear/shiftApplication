        ...
        <body>
            ...
            <div class='body clear'>
                @foreach($shifts as $shift)
                    ...
                    <div class='right'>
                        <button type='button' onclick="location.href='/shifts/confirm/{{ $shift->id }}'">詳細</button>
                        <button type='button' onclick="location.href='/shifts/confirm/{{ $shift->id }}/edit'">編集</button>
                        
                        <form action="/shifts/confirm/{{ $shift->id }}" id="form_{{ $shift->id }}" method="post">
                            @csrf
                            @method('DELETE')
            ...
            <div class='fotter clear right'>
                <button type='button' onclick="location.href='/shifts/confirm/desired'">シフト候補日一覧</button>
